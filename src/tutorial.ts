...
export interface TutorialStep {
    ...
    condition?: () => boolean; // Optional condition to auto-advance
    skipButton?: boolean;
}
...
export class Tutorial {
    ...
    private positionTutorialBox(position: TutorialStep['position'], highlightElement?: string): void {
    ...
    private checkStepCondition(step: TutorialStep): void {
