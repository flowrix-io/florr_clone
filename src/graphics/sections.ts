import { Graphics, MapElement, ACTUAL_WORLD_WIDTH, ACTUAL_WORLD_HEIGHT } from './core';

declare module './core' {
    interface Graphics {
        getBiomeAtPosition(x: number, y: number): MapElement | null;
        getSectionAtPosition(x: number, y: number): number;
        getAdjacentSections(section: number): number[];
        updateSectionTextures(playerX: number, playerY: number): void;
        getClosestEdgeTexture(x: number, y: number): { texture: HTMLImageElement | null, isBiome: boolean };
    }
}

// Method to get biome at a position
Graphics.prototype.getBiomeAtPosition = function(this: Graphics, x: number, y: number): MapElement | null {
...
Graphics.prototype.getSectionAtPosition = function(this: Graphics, x: number, y: number): number {
 ...
 * [6][7][8]
 */
Graphics.prototype.getAdjacentSections = function(this: Graphics, section: number): number[] {
 ...
 */
Graphics.prototype.updateSectionTextures = function(this: Graphics, playerX: number, playerY: number): void {
...
Graphics.prototype.getClosestEdgeTexture = function(this: Graphics, x: number, y: number): { texture: HTMLImageElement | null, isBiome: boolean } {
