import { Graphics, MapElement, seededRandom, WALL_TILE_SIZE, JaggedPoint } from './core';

declare module './core' {
    interface Graphics {
        isEdgeExposed(wall: MapElement, edge: 'top' | 'bottom' | 'left' | 'right', allWalls: MapElement[]): boolean;
        drawWallSpikes(x: number, y: number, width: number, height: number, wall: MapElement, allWalls: MapElement[], pattern: CanvasPattern): void;
        drawWallSpikeShadows(x: number, y: number, width: number, height: number, wall: MapElement, allWalls: MapElement[], shadowSize: number): void;
        drawRandomSpikesOnEdge(startX: number, startY: number, edgeWidth: number, edgeHeight: number, direction: 'top' | 'bottom' | 'left' | 'right', seed: number, minHeight: number, maxHeight: number, minWidth: number, maxWidth: number, minSpacing: number, maxSpacing: number, clusterChance: number): void;
        drawRandomSpikeShadowsOnEdge(startX: number, startY: number, edgeWidth: number, edgeHeight: number, direction: 'top' | 'bottom' | 'left' | 'right', seed: number, minHeight: number, maxHeight: number, minWidth: number, maxWidth: number, minSpacing: number, maxSpacing: number, clusterChance: number, shadowSize: number): void;
        drawJaggedEdge(worldX: number, worldY: number, edge: 'top' | 'bottom' | 'left' | 'right', points: JaggedPoint[], pattern: CanvasPattern): void;
        drawSmoothedEdge(worldX: number, worldY: number, edge: 'top' | 'bottom' | 'left' | 'right', points: JaggedPoint[], fillColor: string, strokeColor: string): void;
    }
}
 ...
 */
Graphics.prototype.isEdgeExposed = function(
    this: Graphics,
    wall: MapElement,
 ...
 */
Graphics.prototype.drawWallSpikes = function(
    this: Graphics,
    x: number,
    y: number,
    width: number,
 ...
 */
Graphics.prototype.drawWallSpikeShadows = function(
    this: Graphics,
    x: number,
    y: number,
    width: number,
 ...
 */
Graphics.prototype.drawRandomSpikesOnEdge = function(
    this: Graphics,
    startX: number,
    startY: number,
    edgeWidth: number,
 ...
 */
Graphics.prototype.drawRandomSpikeShadowsOnEdge = function(
    this: Graphics,
    startX: number,
    startY: number,
    edgeWidth: number,
 ...
 */
Graphics.prototype.drawJaggedEdge = function(
    this: Graphics,
 ...
 */
Graphics.prototype.drawSmoothedEdge = function(
    this: Graphics,
    worldX: number, worldY: number,
    edge: 'top' | 'bottom' | 'left' | 'right',
    points: JaggedPoint[],
