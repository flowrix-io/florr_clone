import { Graphics, ACTUAL_WORLD_WIDTH, ACTUAL_WORLD_HEIGHT, SECTION_CONFIGS } from './core';

declare module './core' {
    interface Graphics {
        drawScrollingBackground(): void;
    }
}

Graphics.prototype.drawScrollingBackground = function(this: Graphics): void {
