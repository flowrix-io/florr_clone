 ...
 */
export function emitPetalRestored(playerId: string, payload: unknown): void {
    getWireOutbox().toPlayer(playerId, 'petalRestored', payload);
}
...
export function emitPetalBroken(
    ...
    getWireOutbox().near(x, y, 'petalBroken', payload, playerId);
}
