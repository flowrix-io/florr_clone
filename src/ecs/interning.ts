...
export class StringInterner {
    ...
    constructor(readonly label: string, seed: ReadonlyArray<string> = []) {
        for (const s of seed) this.intern(s);
    }
 ...
 */
export const mobTypes = new StringInterner('mobType');

/** Petal type names (`'basic'`, `'rose'`, ...), interned on first use. */
export const petalTypes = new StringInterner('petalType');
