 ...
 */
export const IsPlayerRender = defineTag('IsPlayerRender');
 ...
 */
export const NeedsSnap = defineTag('NeedsSnap');
 ...
 */
export const MobRender = defineComponent('MobRender', {
...
export const DpsLabel = defineComponent('DpsLabel', {
    value: 'f32',
});
 ...
 */
export const LegacyPlayer = defineComponent('LegacyPlayer', {
    ref: 'obj',
});
