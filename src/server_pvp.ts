        ...
        if (player) {
            ...
            for (const enemy of enemies) {
                ...
                if (
                    ...
                    collision = true;
                    console.log(`[SERVER_PVP] Enemy collision detected: player(${newX.toFixed(1)}, ${newY.toFixed(1)}, ${PLAYER_SIZE}x${PLAYER_SIZE}) vs enemy(${enemy.x.toFixed(1)}, ${enemy.y.toFixed(1)}, ${enemySize}x${enemySize}) tier:${enemy.tier} id:${enemy.id}`);
