...
function loadIconImage(iconName) {
    const entry = game_icons_net_icons_1.GAME_ICONS_NET_ICONS.find((i) => i.name === iconName);
...
exports.TitleCanvasButtons = TitleCanvasButtons;
