...
class DailyStreakWidget {
    ...
    update(state) {
        ...
        if (state.newDay)
            this.pulseUntilMs = performance.now() + DailyStreakWidget.PULSE_MS;
        this.lastSig = '';
...
DailyStreakWidget.PANEL_BORDER = (0, shapes_1.darken)(DailyStreakWidget.PANEL_BG);
...
DailyStreakWidget.PULSE_MS = 3000;
