...
exports.Corrupted = exports.Glitched = exports.InMaze = exports.InPvpArena = exports.IsLobby = exports.IsBot = exports.IsPlayer = exports.SpawnPreference = exports.Currency = exports.MobKills = exports.SecondChance = exports.KilledBy = exports.Social = exports.MazeState = exports.PvpState = exports.TransferState = exports.TeleporterState = exports.Viewport = exports.PlayerEffects = exports.PetalPositions = exports.PlayerModifiers = exports.Cosmetics = exports.MazeLoadoutPreset = exports.StashedProgress = exports.Loadout = exports.Inventory = exports.ParkedProgression = exports.Progression = exports.PlayerInput = exports.PlayerIdentity = void 0;
const component_1 = require("../component");
/** Display name and owning account. The socket id is the entity's external id. */
exports.PlayerIdentity = (0, component_1.defineComponent)('PlayerIdentity', {
    name: 'str',
 ...
 */
exports.PlayerInput = (0, component_1.defineComponent)('PlayerInput', {
 ...
 * the maze.
 */
exports.Progression = (0, component_1.defineComponent)('Progression', {
    level: 'u16',
    xp: 'f64',
    xpToNextLevel: 'f64',
    score: 'f64',
 ...
 */
exports.ParkedProgression = (0, component_1.defineComponent)('ParkedProgression', {
...
exports.Inventory = (0, component_1.defineComponent)('Inventory', {
    items: 'obj',
});
/** The equipped petals (`(Item | null)[]`). */
exports.Loadout = (0, component_1.defineComponent)('Loadout', {
    slots: 'obj',
});
/**
 ...
 */
exports.StashedProgress = (0, component_1.defineComponent)('StashedProgress', {
    inventory: 'obj',
    loadout: 'obj',
});
/**
 ...
 */
exports.MazeLoadoutPreset = (0, component_1.defineComponent)('MazeLoadoutPreset', {
    slots: 'obj',
});
/** Appearance. All broadcast, so clients render the right flower. */
exports.Cosmetics = (0, component_1.defineComponent)('Cosmetics', {
    flowerColor: 'str',
...
exports.PlayerEffects = (0, component_1.defineComponent)('PlayerEffects', {
    list: 'obj',
});
/** The client's effective viewport, used to decide what to stream it. */
exports.Viewport = (0, component_1.defineComponent)('Viewport', {
    width: 'f32',
    height: 'f32',
});
/** Teleporter charge state. */
exports.TeleporterState = (0, component_1.defineComponent)('TeleporterState', {
...
exports.TransferState = (0, component_1.defineComponent)('TransferState', {
    token: 'str',
});
/** PVP arena score, reset when the player leaves the arena. */
exports.PvpState = (0, component_1.defineComponent)('PvpState', {
    score: 'f64',
 ...
 */
exports.MazeState = (0, component_1.defineComponent)('MazeState', {
...
exports.Social = (0, component_1.defineComponent)('Social', {
    squadId: 'str',
    /** 5-char alphanumeric guild name, rendered as [NAME]. */
    guildName: 'str',
});
/** What killed this player, for the death screen. */
exports.KilledBy = (0, component_1.defineComponent)('KilledBy', {
    type: 'u16',
    tier: 'u8',
});
/** Second-chance talent cooldown. */
exports.SecondChance = (0, component_1.defineComponent)('SecondChance', {
    cooldownUntil: 'f64',
});
/** Per-mob-type kill counters (`mobType -> rarity -> count`). */
exports.MobKills = (0, component_1.defineComponent)('MobKills', {
    counts: 'obj',
});
/** In-game currency earned from challenges and codes. */
exports.Currency = (0, component_1.defineComponent)('Currency', {
    stars: 'f64',
});
/** The biome chosen on the title screen, used when respawning. */
exports.SpawnPreference = (0, component_1.defineComponent)('SpawnPreference', {
    biome: 'str',
});
// --- state tags --------------------------------------------------------------
exports.IsPlayer = (0, component_1.defineTag)('IsPlayer');
/** A server-driven bot rather than a real connection. */
exports.IsBot = (0, component_1.defineTag)('IsBot');
/**
 ...
 */
exports.IsLobby = (0, component_1.defineTag)('IsLobby');
exports.InPvpArena = (0, component_1.defineTag)('InPvpArena');
exports.InMaze = (0, component_1.defineTag)('InMaze');
/**
 ...
 */
exports.Glitched = (0, component_1.defineTag)('Glitched');
/**
 ...
 */
exports.Corrupted = (0, component_1.defineTag)('Corrupted');
