        ...
        if (user) {
            ...
            if (credentials.spawnBiome === 'pvp') {
                ...
                if (constants_2.players[socket.id].inMaze) {
                    ...
                    (0, playerManager_1.enterMazeState)(constants_2.players[socket.id], io);
                }
            ...
            socket.emit('currentPlayers', (0, playerWire_1.sanitizePlayersForClient)(constants_2.players, socket.id));
            ...
            socket.broadcast.emit('newPlayer', (0, playerWire_1.sanitizePublicPlayerForClient)(constants_2.players[socket.id]));
        }
        else {
            socket.emit('authenticated', {
                success: false,
...
const MAX_WANDER_STEP = constants_2.MAX_SPEED / 30;
...
function wanderSizeFactor(enemy) {
    ...
    if (radius === undefined) {
        ...
        radius = stats ? (stats.size * 40) / 2 : constants_2.ENEMY_SIZE / 2;
    }
