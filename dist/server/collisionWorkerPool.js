...
exports.PARAM_SLOTS = exports.CONTROL_SLOTS = exports.CollisionWorkerPool = exports.MAX_PARALLEL_ENTRIES = void 0;
exports.defaultWorkerCount = defaultWorkerCount;
const worker_threads_1 = require("worker_threads");
const os = __importStar(require("os"));
const path = __importStar(require("path"));
/** Hard cap on the mobs one parallel pass can carry. Above this: serial. */
exports.MAX_PARALLEL_ENTRIES = 16384;
...
class CollisionWorkerPool {
    constructor(workerCount = defaultWorkerCount(), entryPath) {
        this.workers = [];
        this.generation = 0;
        this.disposed = false;
        this.workerCount = workerCount;
        const N = exports.MAX_PARALLEL_ENTRIES;
        this.buffers = {
        ...
        for (let i = 0; i < workerCount; i++) {
            const worker = new worker_threads_1.Worker(entry, { workerData: { buffers: b, index: i } });
    ...
    canHandle(count) {
        return !this.disposed && this.workerCount > 0 && count <= exports.MAX_PARALLEL_ENTRIES;
    }
    /**
     ...
     */
    run(count, maxRadius, cellSize, collisionBuffer, maxPushPerPair, nullHead, hashMask, runMainShare) {
        ...
        while (Atomics.load(this.control, CTL_PENDING) > 0) {
            ...
            if (pending > 0)
                Atomics.wait(this.control, CTL_PENDING, pending, 50);
        }
    }
...
exports.CollisionWorkerPool = CollisionWorkerPool;
exports.CONTROL_SLOTS = {
