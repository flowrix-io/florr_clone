...
class ChangelogManager {
    ...
    render() {
        ...
        entries.forEach(entry => {
            ...
            this.roundRect(ctx, this.PANEL_X + this.PADDING, contentY - 5, this.PANEL_WIDTH - this.PADDING * 2 - (this.contentHeight > this.PANEL_HEIGHT - 40 ? this.SCROLLBAR_WIDTH + 5 : 0), 10, 8);
            ctx.fill();
            // Draw date
            ctx.font = 'bold 20px Ubuntu, sans-serif';
            ctx.fillStyle = '#FFFFFF';
