...
class GameServer {
    ...
    handlePlayerMovement(data) {
        ...
        newX = Math.max(0, Math.min(constants_1.WORLD_WIDTH - constants_1.PLAYER_SIZE, newX));
        newY = Math.max(0, Math.min(constants_1.WORLD_HEIGHT - constants_1.PLAYER_SIZE, newY));
