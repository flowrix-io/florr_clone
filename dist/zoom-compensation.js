...
exports.getBaseDeviceScale = getBaseDeviceScale;
 ...
 */
function applyZoomCompensation(canvas, antialiasing = true, hidpi = false) {
 ...
 */
function canvasCoords(canvas, e, hidpi = false) {
