...
core_1.Graphics.prototype.drawPvpArenaBoundary = function () {
    const ctx = this.ctx;
    ...
    const arenaLeft = constants_1.PVP_ARENA_CENTER_X - constants_1.PVP_ARENA_RADIUS;
    const arenaRight = constants_1.PVP_ARENA_CENTER_X + constants_1.PVP_ARENA_RADIUS;
    const arenaTop = constants_1.PVP_ARENA_CENTER_Y - constants_1.PVP_ARENA_RADIUS;
    const arenaBottom = constants_1.PVP_ARENA_CENTER_Y + constants_1.PVP_ARENA_RADIUS;
    ...
    ctx.save();
    ctx.beginPath();
    ctx.arc(constants_1.PVP_ARENA_CENTER_X, constants_1.PVP_ARENA_CENTER_Y, constants_1.PVP_ARENA_RADIUS, 0, Math.PI * 2);
    ctx.clip();
    ...
    const firstX = constants_1.PVP_ARENA_CENTER_X + Math.ceil((gridLeft - constants_1.PVP_ARENA_CENTER_X) / ARENA_GRID_CELL) * ARENA_GRID_CELL;
    const firstY = constants_1.PVP_ARENA_CENTER_Y + Math.ceil((gridTop - constants_1.PVP_ARENA_CENTER_Y) / ARENA_GRID_CELL) * ARENA_GRID_CELL;
    ctx.beginPath();
    ...
    ctx.beginPath();
    ctx.arc(constants_1.PVP_ARENA_CENTER_X, constants_1.PVP_ARENA_CENTER_Y, constants_1.PVP_ARENA_RADIUS - 8, 0, Math.PI * 2);
    ctx.stroke();
    ctx.restore();
};
...
function formatScore(s) {
    if (s >= 1000000)
        return (s / 1000000).toFixed(s >= 10000000 ? 0 : 1) + 'M';
    if (s >= 1000)
