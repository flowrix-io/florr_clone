...
Object.defineProperty(exports, "PETAL_RING_ROTATION_SPEED", { enumerable: true, get: function () { return mobs_1.PETAL_RING_ROTATION_SPEED; } });
...
class Graphics {
    ...
    constructor(canvas, playerSprite, wallTexture, healthPotionSprite, speedBoostSprite, shieldSprite, backgroundTexture) {
        ...
        this.ENEMY_COLORS = petals_1.ITEM_RARITY_COLORS;
    ...
    showDamageText(enemyId, x, y, damage, fromPoison = false) {
        const now = Date.now();
...
Graphics.POISON_TEXT_COLOR = '#ce76db';
