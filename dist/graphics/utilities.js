...
core_1.Graphics.prototype.formatNumber = function (num) {
...
core_1.Graphics.prototype.drawCorpse = function (x, y, angle, player) {
    this.ctx.save();
    ...
    this.drawFlower({
        ...
        faceFlags: core_1.FaceFlags.DeadEyes,
...
core_1.Graphics.prototype.setShowConsoleLogs = function (enabled) {
...
core_1.Graphics.prototype.addConsoleLog = function (args, color) {
...
core_1.Graphics.prototype.drawConsoleLogs = function () {
    if (!this.showConsoleLogs_ || this.consoleLogs.length === 0)
        return;
    const now = Date.now();
    // Remove expired logs
...
core_1.Graphics.prototype.showDeathScreen = function (killedBy) {
...
core_1.Graphics.prototype.hideDeathScreen = function () {
    this.deathScreenVisible = false;
    this.deathScreenButtonHovered = false;
    this.deathScreenCloseHovered = false;
};
core_1.Graphics.prototype.drawDeathScreen = function () {
