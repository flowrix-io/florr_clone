...
core_1.Graphics.prototype.calculateFramesPerCycle = function (svg, frameTime) {
    ...
    for (let i = 1; i < uniqueDurations.length; i++) {
        cycleDuration = core_1.Graphics.lcm(cycleDuration, uniqueDurations[i]);
 ...
 */
core_1.Graphics.prototype.preloadMobFrames = function (mobStats, cacheKey, preloadPromises, baseCacheKey) {
 ...
 */
core_1.Graphics.prototype.loadMobFrames = function (mobStats, cacheKey) {
